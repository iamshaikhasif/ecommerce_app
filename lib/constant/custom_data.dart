...
List<GadgetDetail> cartList = [
  ...
  GadgetDetail(name: 'Air pods', price: '150.00', color: kLightYellow, image: 'assets/images/airpods.png'),
...
List<GadgetDetail> gadgetList = [
  ...
  GadgetDetail(name: 'airpods', price: '60.00', color: kLightYellow, image: ImageResource.airpods),
];

List<GadgetDetail> gadgetreCommendationList = [
  GadgetDetail(name: 'smart watch', price: '100.00', color: kLightYellow, image: ImageResource.watchBlack, imageColor: kDarkYellow),
  GadgetDetail(name: 'headphone', price: '77.00', color: kOrange, image: ImageResource.headphoneRed1, imageColor: kDarkOrange),
  GadgetDetail(name: 'apple watch', price: '67.99', color: kLightGreen, image: ImageResource.appleWatch, imageColor: kDarkGreen),
];